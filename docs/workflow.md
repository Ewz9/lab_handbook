# Administrative Workflow & Reimbursement  
# 行政事務與報帳流程
...
??? info "實驗室離開前業務交接"
    ...
    * 請依照[此處資料夾內](https://github.com/Ewz9/lab_handbook/tree/main/template)格式整理研究相關檔案(e.g.研究論文、報告投影片等)後交給教師。  
